...
namespace EDDW.Controllers
{
    public class SponsorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Inforamtion,Logo")] Sponsor sponsor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Inforamtion,Logo")] Sponsor sponsor)
        {
            if (id != sponsor.Id)
            {
                return NotFound();
